def display_longest_sentence(string)
  string.gsub!("\n", " ")
  string = string.split(/[.!?]/)
  
  string.sort_by! do |sentence|
    sentence.split.size
  end
  longest_sentence = string.last.strip
  puts "=> #{longest_sentence}"
  puts "=> This sentence is #{longest_sentence.split.size} words long."
end

p longest_sentence("Four score and seven years ago our fathers brought forth on this continent a new nation, conceived in liberty, and dedicated to the proposition that all men are created equal.
