...
# # iterate through the array and return a new array with subarrays that only contain elements that are multiples of 3

# # access all elements of the array
# # access all elements of sub_arrays
# #   select any elements that are multiples of 3
